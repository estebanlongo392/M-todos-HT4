import numpy as np
# Nuevos datos de entrada, incluyendo el nuevo punto (3.5, 0.42)
x = np.array([0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5])
y = np.array([1.62, 1.0, 0.75, 0.62, 0.52, 0.46, 0.42])
...
print("Coeficientes de las diferencias divididas con el nuevo punto:")
for i in range(n):
